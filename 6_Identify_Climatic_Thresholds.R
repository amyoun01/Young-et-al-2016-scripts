...
# BETWEEN CLIMATE AND THE 30-YR PROBABILITY OF FIRE OCCURENCE.                                        
#                                                                                   
# FILE REQUIREMENTS:
...
#       '1_AK_FINAL_RESULTS') these files are named:
#
#       - 'partDep_TempWarm.csv'
#       - 'partDep_AnnDEF.csv'

# DEPENDENCIES:
#   (1) segmented package (version 0.5-1.4)
#
...
mdl_dir <- c("1_AK_FINAL_RESULTS","2_BOREAL_FINAL_RESULTS","3_TUNDRA_FINAL_RESULTS")
...
for (m in 1:length(mdl_dir)){ # FOR EACH MODEL ...
  ...
  setwd(paste(wdir,output_dir,mdl_dir[m],sep = "")) # ... CHANGE THE WORKING DIRECTORY
